...
public class CodeDownloadWithAssets extends AnAction {
    ...
    public CodeDownloadWithAssets() {
        super("Code Download with Assets");
    }
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        String command = "dart pub global run flutterflow_cli export-code --project " + projectID + " --dest " + destinationPath + " --include-assets --token " + apiToken;
